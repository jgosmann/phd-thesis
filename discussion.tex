...
Extending CUE model with slow learning of either direct position to item associations or forward associations, allowed to reproduce the Hebb repetition effect.
...
Neither the OSE, nor the TCM model attempted to match this data.
