...
Apart from this theoretical argument, it might be possible to differentiate experimentally between the context representation used in the CUE model and the scale-invariant fuzzy memory.
