...
The model allows to selectively disable the recall from the STM or LTM component.
...
A number of resulting metrics from the model and experimental data is shown in \cref{fig:results-free}.
