...
To associate items and contexts, two transformation matrices are used.
...
Finally, in this thesis I am using a different winner-take-all process as described in \cref{sec:recall}.
