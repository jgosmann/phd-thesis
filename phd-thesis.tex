...
\addsym{\dec}{d}{\vc d}{NEF decoding vector}
\addsym{\menc}{E}{\mat E}{NEF encoder matrix}
...
\begin{itemize}
    ...
    \item changes with regard to original TCM: finite vector dimensionality, not perfectly orthogonal
\end{itemize}
\chapter{Conclusion}
