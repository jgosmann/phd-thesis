...
\addsym{\dec}{encoder}{\vc d}{NEF Decoder}
...
\addsym{\repspace}{X}{\mathcal{X}}{NEF representational space}
...
\addsym{\iu}{i}{\mathrm{i}}{Imaginary unit}
% TODO dot product notation, element-wise product
...
\include{nef}
\include{spa}
\chapter{Optimal high-dimensional representation in spiking neurons}
