...
% TODO foot note explaining the dilemma
dilemma depend on working memory capacity \parencite{milinski1998}.
...
Furthermore, many models of memory or learning focus on either small scale neural changes without any direct connection to behaviour, or on idealized behaviour
% TODO references to examples of the kind of work I am complaining about
described with mathematical equations, but no solid grounding in biological plausibility.
...
I discuss this model in more detail in Section TODO, and demonstrate that it is highly sensitive to noise, which is prohibitive to a neural implementation.
