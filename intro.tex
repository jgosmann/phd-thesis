...
Closely related to grid and place cells is the hippocampal theta oscillation found in rats.
...
\begin{itemize}
    \item TODO fuzzy temporal memory
\end{itemize}
...
\subsection{Summary}
Despite many existing models, a number of questions has not been sufficiently addressed.
